...
**Module root package:** The public `Diff()` function should be exported from the module root package (or from a subpackage like `github.com/user/composer-diff/diff`).
