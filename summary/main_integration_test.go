...
var _integrationFullChanges = contract.DiffMap{
	"caution-dev_only_usage-requirement/ADDITION+ABANDONED": {
		Package: &difftesting.TestPkgWrapper{
			...
			Abandoned:          true,
			Version:            contract.PkgVersion{Raw: "1.18.4", Label: "1.18.4", Semver: &semver.Version{Major: 1, Minor: 18, Patch: 4, Extra: ""}},
	...
	"caution-dev_only_usage-requirement/SEMVER_MAJOR_DOWNGRADE": {
		...
		PreviousVersion: contract.PkgVersion{Raw: "2.9.2", Label: "2.9.2", Semver: &semver.Version{Major: 2, Minor: 9, Patch: 2, Extra: ""}},
	},
	...
	"caution-dev_only_usage-requirement/UNKNOWN_UPDATE+SEMVER_EXTRA": {
		Package: &difftesting.TestPkgWrapper{
			...
			Abandoned:          false,
			Version:            contract.PkgVersion{Raw: "2.9.2+alpha", Label: "2.9.2+alpha", Semver: &semver.Version{Major: 2, Minor: 9, Patch: 2, Extra: ""}},
			Link:               "http://www.squizlabs.com/php-codesniffer",
			DevOnly:            true,
			RootRequirement:    false,
			RootDevRequirement: true,
		...
		PreviousVersion: contract.PkgVersion{Raw: "2.9.2+beta", Label: "2.9.2+beta", Semver: &semver.Version{Major: 2, Minor: 9, Patch: 2, Extra: "+beta"}},
	},
	...
	"warning-dev_only_usage-requirement/SEMVER_MAJOR_UPGRADE": {
		...
		PreviousVersion: contract.PkgVersion{Raw: "2.9.3", Label: "2.9.3", Semver: &semver.Version{Major: 2, Minor: 9, Patch: 3, Extra: ""}},
	},
	...
	"warning-dev_only_usage-requirement/SEMVER_MINOR_DOWNGRADE": {
		...
		PreviousVersion: contract.PkgVersion{Raw: "3.1.0", Label: "3.1.0", Semver: &semver.Version{Major: 3, Minor: 1, Patch: 0, Extra: ""}},
	},
	...
	"important-dev_only_usage-requirement/REMOVAL": {
		Package: &difftesting.TestPkgWrapper{
			...
			Abandoned:          false,
			Version:            contract.PkgVersion{Raw: "3.0.1", Label: "3.0.1", Semver: &semver.Version{Major: 3, Minor: 0, Patch: 1, Extra: ""}},
			Link:               "http://www.squizlabs.com/php-codesniffer",
			DevOnly:            true,
			RootRequirement:    false,
			RootDevRequirement: true,
	...
	"important-dev_only_usage-requirement/REMOVAL+ABANDONED": {
		Package: &difftesting.TestPkgWrapper{
			...
			Abandoned:          true,
			Version:            contract.PkgVersion{Raw: "3.2.1", Label: "3.2.1", Semver: &semver.Version{Major: 3, Minor: 2, Patch: 1, Extra: ""}},
			Link:               "http://www.squizlabs.com/php-codesniffer",
			DevOnly:            true,
			RootRequirement:    false,
			RootDevRequirement: true,
	...
	"important-dev_only_usage-requirement/SEMVER_PATCH_DOWNGRADE": {
		...
		PreviousVersion: contract.PkgVersion{Raw: "3.0.1", Label: "3.0.1", Semver: &semver.Version{Major: 3, Minor: 0, Patch: 1, Extra: ""}},
	},
	...
	"tip-dev_only_usage-requirement/SEMVER_MINOR_UPGRADE": {
		...
		PreviousVersion: contract.PkgVersion{Raw: "3.0.0", Label: "3.0.0", Semver: &semver.Version{Major: 3, Minor: 0, Patch: 0, Extra: ""}},
	},
