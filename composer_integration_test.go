	...
	expectedChanges := map[string]depsdiff.PackageChange{
		"sebastian/diff": { // sebastian/diff	4.0.4 	↘️‼️️ 	3.0.3
			...
			Operation: depsdiff.Operation{
				Name:       depsdiff.UpdatedPackage,
				SemverType: depsdiff.DiffSemverMajor,
				Direction:  depsdiff.DiffDirectionDown,
			},
		...
		"symfony/asset": { // symfony/asset	v4.4.27 	↗️️ 	v5.4.21
			...
			Operation: depsdiff.Operation{
				Name:       depsdiff.UpdatedPackage,
				SemverType: depsdiff.DiffSemverMajor,
				Direction:  depsdiff.DiffDirectionUp,
			},
		...
		"yoanm/jsonrpc-server-sdk": { // yoanm/jsonrpc-server-sdk	dev-master#dcd886d❗ 	➡️ 	v1.3.0
			...
			Operation: depsdiff.Operation{
				...
				Direction:  depsdiff.DiffDirectionUnknown,
			},
		...
		"yoanm/jsonrpc-server-doc-sdk": { // yoanm/jsonrpc-server-doc-sdk	➕️ 	dev-master#a0febcc❗
			...
			Operation: depsdiff.Operation{
				Name:       depsdiff.AddedPackage,
				SemverType: depsdiff.DiffSemverNone,
				Direction:  depsdiff.DiffDirectionNone,
			},
